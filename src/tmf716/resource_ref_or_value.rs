...
use super::{
    AttachmentRefOrValue, Characteristic, Feature, Note, RelatedParty,
    RelatedPlaceRefOrValue, ResourceAdministrativeStateType,
    ResourceOperationalStateType, ResourceRelationship, ResourceSpecificationRef,
    ResourceStatusType, ResourceUsageStateType,
};
