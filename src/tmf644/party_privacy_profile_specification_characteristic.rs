...
pub struct PartyPrivacyProfileSpecificationCharacteristic {
    ...
    pub allowed_role: Vec<PartyRoleSpecificationRef>,
...
impl std::fmt::Display for PartyPrivacyProfileSpecificationCharacteristic {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        write!(f, "{}", serde_json::to_string(self).unwrap())
    }
}
impl std::ops::Deref for PartyPrivacyProfileSpecificationCharacteristic {
    type Target = CharacteristicSpecification;
    fn deref(&self) -> &Self::Target {
        &self.characteristic_specification
    }
}
impl std::ops::DerefMut for PartyPrivacyProfileSpecificationCharacteristic {
    fn deref_mut(&mut self) -> &mut Self::Target {
        &mut self.characteristic_specification
    }
}
