...
/// Agreement Authorization FVO
#[derive(Debug, Clone, Serialize, Deserialize, Default)]
pub struct AgreementAuthorizationMvo {
...
impl std::fmt::Display for AgreementAuthorizationMvo {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        write!(f, "{}", serde_json::to_string(self).unwrap())
    }
}
impl std::ops::Deref for AgreementAuthorizationMvo {
    type Target = Extensible;
    fn deref(&self) -> &Self::Target {
        &self.extensible
    }
}
impl std::ops::DerefMut for AgreementAuthorizationMvo {
