...
///Geographic Sub-Address Unit
#[derive(Debug, Clone, Serialize, Deserialize, Default)]
pub struct GeographicSubAddressUnitMvo {
...
impl std::fmt::Display for GeographicSubAddressUnitMvo {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        write!(f, "{}", serde_json::to_string(self).unwrap())
    }
}
impl std::ops::Deref for GeographicSubAddressUnitMvo {
    type Target = Extensible;
    fn deref(&self) -> &Self::Target {
        &self.extensible
    }
}
impl std::ops::DerefMut for GeographicSubAddressUnitMvo {
