...
pub struct ChangeRequestStatusChangeEvent {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub event: Option<ChangeRequestStatusChangeEventPayload>,
...
impl std::fmt::Display for ChangeRequestStatusChangeEvent {
