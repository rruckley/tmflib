...
use super::{
    AttachmentRefFvo, CharacteristicFvo, Entity, ExternalIdentifierFvo, FeatureFvo,
    ...
    ResourceSpecificationRefFvo, ResourceStatusType, ResourceUsageStateType, TimePeriod,
};
