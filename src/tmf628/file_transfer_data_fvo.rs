...
pub struct FileTransferDataFvo {
    ...
    #[serde(flatten)]
    pub protocol_transfer_data_fvo: ProtocolTransferDataFvo,
    ///File compression type.
    #[serde(rename = "compressionType")]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub compression_type: Option<CompressionType>,
    ///File format of the transferred file.
...
impl std::fmt::Display for FileTransferDataFvo {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        write!(f, "{}", serde_json::to_string(self).unwrap())
    }
}
impl std::ops::Deref for FileTransferDataFvo {
    type Target = ExtensibleFvo;
    fn deref(&self) -> &Self::Target {
        &self.extensible_fvo
    }
}
impl std::ops::DerefMut for FileTransferDataFvo {
