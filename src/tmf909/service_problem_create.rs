...
pub struct ServiceProblemCreate {
    ...
    #[serde(rename = "firstAlert")]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub first_alert: Option<RelatedEntity>,
    ...
    pub originator_party: RelatedParty,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tracking_record: Option<Vec<TrackingRecord>>,
...
impl std::fmt::Display for ServiceProblemCreate {
