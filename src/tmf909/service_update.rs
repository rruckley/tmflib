use super::{
    Characteristic, Feature, RelatedEntityRefOrValue, RelatedParty, RelatedPlaceRefOrValue,
    RelatedServiceOrderItem, ResourceRef, ServiceRefOrValue, ServiceRelationship,
...
impl std::fmt::Display for ServiceUpdate {
