...
pub struct QueryServiceQualification {
    ...
    #[serde(rename = "queryServiceQualificationDate")]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub query_service_qualification_date: Option<crate::DateTime>,
...
impl std::fmt::Display for QueryServiceQualification {
