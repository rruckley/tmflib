...
use tmf_642::request::clear_alarm_state_change_event::ClearAlarmStateChangeEventRequired;
#[tokio::main]
async fn main() {
    ...
    let response = client
        .clear_alarm_state_change_event(ClearAlarmStateChangeEventRequired {
            base_type,
            schema_location,
            type_,
