...
use tmf_642::request::alarm_attribute_value_change_event::AlarmAttributeValueChangeEventRequired;
#[tokio::main]
async fn main() {
    ...
    let response = client
        .alarm_attribute_value_change_event(AlarmAttributeValueChangeEventRequired {
            base_type,
            schema_location,
            type_,
