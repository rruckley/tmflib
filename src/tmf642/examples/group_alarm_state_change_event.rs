...
use tmf_642::request::group_alarm_state_change_event::GroupAlarmStateChangeEventRequired;
#[tokio::main]
async fn main() {
    ...
    let response = client
        .group_alarm_state_change_event(GroupAlarmStateChangeEventRequired {
            base_type,
            schema_location,
            type_,
