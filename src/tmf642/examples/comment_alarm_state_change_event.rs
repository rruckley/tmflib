...
use tmf_642::request::comment_alarm_state_change_event::CommentAlarmStateChangeEventRequired;
#[tokio::main]
async fn main() {
    ...
    let response = client
        .comment_alarm_state_change_event(CommentAlarmStateChangeEventRequired {
            base_type,
            schema_location,
            type_,
