...
use tmf_642::request::un_ack_alarm_state_change_event::UnAckAlarmStateChangeEventRequired;
#[tokio::main]
async fn main() {
    ...
    let response = client
        .un_ack_alarm_state_change_event(UnAckAlarmStateChangeEventRequired {
            base_type,
            schema_location,
            type_,
