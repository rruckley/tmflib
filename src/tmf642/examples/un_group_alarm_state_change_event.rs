...
use tmf_642::request::un_group_alarm_state_change_event::UnGroupAlarmStateChangeEventRequired;
#[tokio::main]
async fn main() {
    ...
    let response = client
        .un_group_alarm_state_change_event(UnGroupAlarmStateChangeEventRequired {
            base_type,
            schema_location,
            type_,
